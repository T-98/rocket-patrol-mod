class Play extends Phaser.Scene {
    ...
    create() {
            ...
            // add spaceships (x3)
            //this.dropship = new Spaceship(this, game.config.width + borderUISize * 6, borderUISize * 4, 'spaceship', 0, 30).setOrigin(0, 0);
    ...
    update() {
        ...
        if (!this.gameOver) {
            ...
            this.dropship.update(); // update spaceships (x3)
            this.ship02.update();
            this.ship03.update();
        }
        // check collision
